<%@ Page Language="C#" AutoEventWireup="true" Inherits="Live" Codebehind="Live.aspx.cs" %>
...
<body>
  ...
  <h1><b>Our Ranges !!</b><small></small></h1>
    ...
    <div class="thumbnail" style="border:double">
      ...
      <a id="ac" href="product.aspx?eventtype=live&"> <img src="pictures/cat-venue.jpg" alt="Lights" style="min-height:350px; height:350px"/></a>
        <div class="caption">
  ...
  <ul class="dropdown-menu" aria-labelledby="abc">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#Rec").click(function () {
                window.location = "Recording.aspx?budget=" + foo;
