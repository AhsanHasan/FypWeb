<%@ Page Language="C#" AutoEventWireup="true" Inherits="BusinessMeetings" Codebehind="BusinessMeetings.aspx.cs" %>
...
<body>
  ...
  <h1><b>Our Ranges !!</b><small></small></h1>
    ...
    <div class="thumbnail" style="border:double">
      ...
      <a id="ac" href="product.aspx?eventtype=meeting&"> <img src="pictures/cat-venue.png" alt="Lights" style="min-height:350px; height:350px"/></a>
        <div class="caption">
