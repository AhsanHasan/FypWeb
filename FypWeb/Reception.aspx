<%@ Page Language="C#" AutoEventWireup="true" Inherits="Reception" Codebehind="Reception.aspx.cs" %>
...
<body>
  ...
  <h1><b>Our Ranges !!</b><small></small></h1>
    ...
    <div class="thumbnail" style="border:double">
        <a href="Packages.aspx?eventtype=reception&"><img src="pictures/cat-theme.jpg" alt="Lights" style="min-height:350px; height:350px"/></a>
         <div class="caption">
        ...
        <%--    <input id="wedtype"type="hidden" value="wedding" />--%>
           ...
           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6" style="left:10px">
    <div class="thumbnail" style="border:double">
       <a href="entertainer.aspx?eventtype=reception&"><img src="pictures/cat-dec.jpg" alt="Lights" style="min-height:350px; height:350px"/></a>
        <div class="caption">
    ...
    <div class="thumbnail" style="border:double">
      ...
      <a id="ac" href="product.aspx?eventtype=reception&"> <img src="pictures/cat-venue.jpg" alt="Lights" style="min-height:350px; height:350px"/></a>
        <div class="caption">
  ...
  <ul class="dropdown-menu" aria-labelledby="abc">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6"style="left:10px">
    <div  class="thumbnail" style="border:double">
       <a href="Foods.aspx?eventtype=reception&"> <img src="pictures/cat-fd.jpg" alt="Lights" style="min-height:350px; height:350px"/></a>
        <div class="caption">
