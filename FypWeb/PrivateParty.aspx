<%@ Page Language="C#" AutoEventWireup="true" Inherits="PrivateParty" Codebehind="PrivateParty.aspx.cs" %>
  ...
  <ul class="dropdown-menu" aria-labelledby="abc">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#BParty").click(function () {
                window.location = "BayParty.aspx?budget=" + foo;
