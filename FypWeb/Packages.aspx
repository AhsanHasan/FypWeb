<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Packages.aspx.cs" Inherits="FypWeb.Packages" %>
...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:'Open Sans',sans-serif,arial,helvetica,verdana">
    ...
    <table class="table product-table">
        ...
        <tbody>
                  ...
                  <td><img src='<%#Eval("Picture") %>' height="200" width="400" style="border: solid"></td>
                      <td ><%#Eval("Name") %> </td>
                  <td ><%#Eval("Price") %> </td>
                  <td ><%#Eval("Address") %> </td>
                  <td ><%#Eval("Contact") %> </td>
