<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisitorEventType.aspx.cs" Inherits="FypWeb.VisitorEventType" %>
...
<div class="modal fade modal-ku " id="mymodal" role="dialog" data-backdrop="static"> 
  ...
  <ul class="dropdown-menu" aria-labelledby="abc">
   ...
   <li> <a id="mehndiid" class="dropdown-item" href="VMehndi.aspx?eventtype=mehndi&">Mehndi</a></li>
      <li> <a id="baraatid" class="dropdown-item" href="VBaraat.aspx?eventtype=Baraat&">Baraat</a></li>
    <li><a id="receptionid" class="dropdown-item"  href="VReception.aspx?eventtype=reception&">Reception</a></li>
          <li role="separator" class="divider"></li>
  </ul>
</div>
  ...
  <ul class="dropdown-menu" aria-labelledby="abc">
        <li role="separator" class="divider"></li>
   <li> <a id="liveid"class="dropdown-item" href="VLive.aspx?eventtype=live&">Live Concerts</a></li>
...
<div class="row">
  ...
  <ul class="dropdown-menu" aria-labelledby="abc">
        <li role="separator" class="divider"></li>
   <li> <a id="ppartyid"class="dropdown-item" href="VPrivateParty.aspx?eventtype=party&">Private Party</a></li>
      <li> <a id="bpartyid"class="dropdown-item" href="VBayParty.aspx?eventtype=party&">Beach Party</a></li>
  ...
  <ul class="dropdown-menu" aria-labelledby="abc">
        <li role="separator" class="divider"></li>
   <li> <a id="meetingid"class="dropdown-item" href="VMeetings.aspx?eventtype=meeting&">Meetings</a></li>
