<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="FypWeb.Category" %>
<!DOCTYPE html>
...
<body>
  ...
  <h1><b>Our Ranges !!</b><small></small></h1>
    ...
    <div class="thumbnail" style="height:120%;border:double">
    ...
    <div class="thumbnail" style="border:double">
      ...
      <a id="ven" href="Baraat.aspx"> <img src="pictures/cat-venue.jpg" alt="Lights" style="min-height:350px; height:350px"/></a>
        <div class="caption">
  ...
  <ul class="dropdown-menu" aria-labelledby="abc">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6"style="left:10px">
    <div  class="thumbnail" style="border:double">
       <a href="#"> <img src="pictures/cat-fd.jpg" alt="Lights" style="min-height:350px; height:350px"/></a>
        <div class="caption">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#ven").click(function () {
                ...
                var cl = $("#ven").attr("href");
                var eventtype = cl + "budget=" + foo;
                $("#ven").attr("href", eventtype);
            }
            });
    </script>
</html>
