<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VMeetings.aspx.cs" Inherits="FypWeb.VMeetings" %>
...
<body>
   ...
   <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6"style="float:left; left:300px">
         ...
         <div style="height:50px"></div>
           <div style="background-color:#f2eaf2;border-color:black;height:250px;">
            ...
            <p style="text-align:center"> We are having best venues of Town with the best prices. Make your event memorable by picking one of the best venues</p>
               ...
               <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6"style="float:left; left:400px">
